    ...
    <div class="page-wrapper bg-blue p-t-100 p-b-100 font-robo">
        <div class="wrapper wrapper--w680">
            <div class="card card-1">
                ...
                <div class="card-body">
                    <h2 class="title">Employee Registration Info</h2>
                    <form action="process/addempprocess.php" method="POST" enctype="multipart/form-data">
                                ...
                                <p>First Name<p style="color:red"> *</p> <input class="input--style-1" type="text" placeholder="First Name" name="firstName" required="required">
                                </div>
                                <br>
                      
                                <div class="input-group">
                                <p>Last Name<p style="color:red"> *</p>   <input class="input--style-1" type="text" placeholder="Last Name" name="lastName" required="required">
                                </div>
