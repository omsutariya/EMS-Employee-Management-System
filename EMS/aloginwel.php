...
<html>
<head>
	<title>Admin Panel | DORA Corporation</title>
...
<body>
	...
	<div id="cont">
		...
		<div class="float-left">
			<button class="btn btn-secondary" type="submit" style="float: right; margin-right: 60px"><a href="reset.php" style="text-decoration: none; color: black"> Reset Points</button>
		</div>
